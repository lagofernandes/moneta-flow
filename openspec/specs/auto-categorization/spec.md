# Auto Categorization Capability Specification
...
- **THEN** the system assigns the mapped system category with `HIGH` confidence sem chamar APIs externas

#### Scenario: Level 2 Batch LLM Classification with Chunking
- **WHEN** a transaction description has no matching local ou global rule
