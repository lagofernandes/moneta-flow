...
- **THEN** the system sends the unique unmatched merchant names to Gemini Flash LLM to match against the user's active categories retrieved from the database, formatted as "Parent > Child" (or just "Parent" if it has no children)
